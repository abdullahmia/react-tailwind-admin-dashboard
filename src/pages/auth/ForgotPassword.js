    ...
    return (
        <main id="content" role="main" className="w-full max-w-md mx-auto p-6">
                    ...
                    <div className="mt-5">
                        <form>
                            <div className="grid gap-y-4">
                                ...
                                <button type="submit" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm">Reset password</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <p className="mt-3 flex justify-center items-center text-center divide-x divide-gray-300">
                <a className="pr-3.5 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 hover:underline hover:text-blue-600" href="#" target="_blank">
