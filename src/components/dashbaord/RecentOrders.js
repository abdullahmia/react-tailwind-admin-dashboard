        ...
        <div className="bg-white p-5 mt-5 shadow rounded">
            ...
            <div className="overflow-x-auto relative shadow-md sm:rounded-lg p-5">
                <div className="flex justify-between items-center pb-4 bg-white">
                    <div>
                        <button onClick={handleActionToggole} className="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 " type="button">
                        ...
                        {/* <!-- Dropdown menu --> */}
                        <div className={`${isActionOpen ? 'block' : 'hidden'} absolute z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow`}>
                            <ul className="py-1 text-sm text-gray-700" aria-labelledby="dropdownActionButton">
                                <li>
                                    <a href="#" className="block py-2 px-4 hover:bg-gray-100 ">Reward</a>
                                </li>
                                <li>
                                    <a href="#" className="block py-2 px-4 hover:bg-gray-100">Promote</a>
                                </li>
                                <li>
                                    <a href="#" className="block py-2 px-4 hover:bg-gray-100">Activate account</a>
                                </li>
                            </ul>
                            <div className="py-1">
                                <a href="#" className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 ">Delete User</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <tbody>
                        <tr className="bg-white border-b">
                            ...
                            <th scope="row" className="flex items-center py-4 px-6 text-gray-900 whitespace-nowrap">
                                <img className="w-10 h-10 rounded-full" src={avatar} alt="Jese" />
                                <div className="pl-3">
